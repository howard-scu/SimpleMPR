...
//
//
//TEST_CASE("TEST SIGNAL/SLOT", "[single-file]")
//{
//	shared_ptr<lwMPRLogic2> viewer1 = make_shared<lwMPRLogic2>();
//	viewer1->SetView(lwMPRLogic2::AXIAL);
//
//	shared_ptr<lwMPRLogic2> viewer2 = make_shared<lwMPRLogic2>();
//	viewer2->SetView(lwMPRLogic2::CORONAL);
//
//	viewer1->SetNextViewer(viewer2.get());
//	viewer1->SetZPosition(22);
//}